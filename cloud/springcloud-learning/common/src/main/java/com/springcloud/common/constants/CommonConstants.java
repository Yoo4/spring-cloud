package com.springcloud.common.constants;

public class CommonConstants {
    public static final Integer EX_TOKEN_ERROR_CODE = 40101;
    public static final Integer EX_USER_INVALID_CODE = 40102;
    public static final Integer EX_CLIENT_INVALID_CODE = 40112;
    public static final Integer EX_OTHER_CODE = 500;
    public static final String CONTEXT_KEY_USERID = "currentUserId";
